...
class StockReport extends StatefulWidget {
  final customer;
  final type;
  const StockReport({Key? key, this.customer, this.type}) : super(key: key);
...
class _StockReportState extends State<StockReport> {
  ...
  Future<void> get_stock(customer_id) async {
    setState(() {
      _saving = true;
    });
    var res = await api.get_stock(customer_id);
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await get_stock(customer_id.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //       // list_inc++;
                    //       // Map _api_data = {
                    //       //   'id': _product_id_controller.text,
                      ...
                      child: _stock_list.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (BuildContext ctx, index) {
                                // Map _api_data = {
                                //   'id': _stock_list[index]['id'].toString(),
                                //   'quantity': _stock_list[index]
                                //           ['quantity_balance']
                                //       .toString(),
                                // };
                                // _stock_for_api[index]['id'] = _api_data;
                                // _stock_for_api.add(_api_data);
                                // print(_stock_for_api);
                                return Card(
                                  child: ListTile(
      ...
      //       Map single = {
      //         "product_id": _stock_list[i]['id'],
      //         "quantity": _stock_list[i]['quantity_balance']
      //       };
      //       my_arr.add(single);
      //     }
            ...
            return Scaffold(
              ...
              body: Column(
                children: [
                  ...
                  //                 product_id = _arr[index]['id'].toString();
